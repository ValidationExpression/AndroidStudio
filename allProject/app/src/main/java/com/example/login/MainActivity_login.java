...
public class MainActivity_login extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.antive_login);
        init();
        ...
        switch (view.getId()){
            ...
            case R.id.butt:
                ...
                if(TextUtils.isEmpty(names)){
                    Toast.makeText(MainActivity_login.this,"请输入名字",Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(edits)){
                    Toast.makeText(MainActivity_login.this,"请输入邮箱",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity_login.this,"注册成功",Toast.LENGTH_SHORT).show();
                    //控制台输出信息
