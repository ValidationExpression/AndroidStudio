...
public class Login extends AppCompatActivity implements View.OnClickListener {
     String email,pwd,email1,pwd1,save_zhanghao,save_pwd;
                ...
                //如果账号和密码为空会进行提示
                 if (TextUtils.isEmpty(email1)) {
                    ...
                    Toast.makeText(Login.this,"请输入密码",Toast.LENGTH_SHORT).show();
                     ...
                     //判断存储的账号密码和文本框内填写的密码是否一致，如果一致就跳转到List_View页面，不一致提示登录失败
                    if( email1.equals(save_zhanghao) && pwd1.equals(save_pwd)  ){
