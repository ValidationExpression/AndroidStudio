...
/**
 * 实现功能当点击读写通信录或发短信时:会触发权限的授予提示.便于用户权限获取(应用打开时就会弹出)
 */
public class PermissionHungryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PermissionUtil.checkPermission(this, PERMISSIONS, REQUEST_CODES);
    }
                        ...
                        if (grantResults[i] != PackageManager.PERMISSION_GRANTED) {
                            ...
                            switch (permissions[i]) {
                                ...
                                case Manifest.permission.WRITE_CONTACTS:
                                    Toast.makeText(this, "通信录读写获取失败", Toast.LENGTH_SHORT).show();
                                    jumToSettings();
